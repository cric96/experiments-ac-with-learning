...
dependencies {
    ...
    implementation("it.unibo.alchemist:alchemist-swingui:$alchemistVersion") //without this dependency, the simulation doesn't produce data
    ...
    //ml dependency
    implementation("com.github.haifengl:smile-scala_$scalaMajor:2.6.0")
